...
python -m yolo_model.scripts.detect_video \
    ...
    --output-json /workspace/agentic/yolo_model/runs/detect_video/results.json \
    --output-csv /workspace/agentic/yolo_model/runs/detect_video/results.csv \
    --save-annotated-video /workspace/agentic/yolo_model/runs/detect_video/annotated.mp4 \
    --device cpu
"""
