...
Usage::
    ...
    python -m yolo_model.scripts.evaluate_pipeline \
        ...
        --output yolo_model/artifacts/eval/pipeline \
        --report yolo_model/artifacts/eval/pipeline_report.json
...
from yolo_model.config.paths import artifacts_dir
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=None,
        help="Working directory for pipeline outputs (default: yolo_model/artifacts/eval/pipeline).",
    )
    ...
    if args.output is None:
        args.output = artifacts_dir() / "eval" / "pipeline"
