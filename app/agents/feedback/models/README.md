...
```bash
# Stage in yolo_model/exports/ first (see yolo_model/docs/training.md):
...
ln -sf highlight_yolo_v1.1.0.pt agents/feedback/models/highlight_yolo_v1.pt
```
...
- `yolo_model/README.md` — layout and quick start.
- `yolo_model/docs/training.md` — exact training commands.
- `yolo_model/docs/production.md` — versioning, rollout, rollback procedure.
