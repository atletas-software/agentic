...
from backendapi.services.sheet_sync import get_due_user_ids_for_sync
from backendapi.services.sync_queue import acquire_user_enqueue_lock, get_sync_queue
        ...
        try:
            ...
            for user_id in due_user_ids:
                if not acquire_user_enqueue_lock(user_id=user_id):
                    continue
                queue.enqueue(
                    "backendapi.workers.sync_worker.process_user_sync_job",
                    user_id,
